...
export function validateCanonicalPrediction(prediction, label = 'Prediction') {
  ...
  assertCondition(prediction.homeWinProbability >= 0 && prediction.homeWinProbability <= 1, `${label}.homeWinProbability must be between 0 and 1`)
  assertCondition(prediction.awayWinProbability >= 0 && prediction.awayWinProbability <= 1, `${label}.awayWinProbability must be between 0 and 1`)
  assertCondition(Math.abs((prediction.homeWinProbability + prediction.awayWinProbability) - 1) <= 0.0002, `${label} probabilities must sum to 1`)
